## Pesquisando Músicos Clássicos - Imersão Dev 2024
...
1. **Digite e pesquise:** Você digita o nome do músico ou música que você quer encontrar na caixinha de pesquisa.
...
3. **Resultados na tela:** Se a aplicação encontrar algo, ela mostra pra você um card com o nome do músico, uma breve descrição e um link para saber mais. Se não encontrar nada, ela te avisa que não teve sorte dessa vez.
...
* **Dados:** Os dados dos músicos estão no arquivo `dados.js`. Você pode adicionar mais dados aí se quiser.
...
**Vamos juntos criar a maior base de dados de compositores da música clássica!**
